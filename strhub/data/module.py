...
class SceneTextDataModule(pl.LightningDataModule):
    ...
    #TEST_BENCHMARK_SUB = ('IIIT5k', 'SVT', 'IC13_1015', 'IC15_2077', 'SVTP', 'CUTE80','mdb_database_test')
    #TEST_BENCHMARK = ('IIIT5k', 'SVT', 'IC13_1015', 'IC15_2077', 'SVTP', 'CUTE80', 'mdb_database_test')
    TEST_BENCHMARK_SUB = ('mdb_database_test',)
    TEST_BENCHMARK = ('mdb_database_test',)
    TEST_NEW = ('mdb_database_test',)
    #TEST_NEW = ('ArT', 'COCOv1.4', 'Uber', 'mdb_database_test')
