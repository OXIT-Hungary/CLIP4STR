...
python ../train.py +experiment=vl4str-large model=vl4str dataset=real \
                    ...
                    trainer.accumulate_grad_batches=1 trainer.max_epochs=5 trainer.gpus=2 \
                    trainer.val_check_interval=10 \
                    model.clip_pretrained=/home/aitrain/Documents/Krisztian/CLIP4STR/pretrained/clip/OpenCLIP-ViT-L-14-DataComp-XL-s13B-b90K.bin
